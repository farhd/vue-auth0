...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SecretQuote = __webpack_require__(34);
	...
	router.map((0, _defineProperty3.default)({
	  ...
	  secretquote: _SecretQuote2.default
	}));
...
/***/ function(module, exports) {
	...
	//     <button type="button" class="btn btn-primary" v-on:click="getQuote()">
	//       Get a quote
	//     </button>
	...
	exports.default = {
	  ...
	  methods: {
	    submit: function submit() {
	      ...
	      _index2.default.login(this, credentials, 'secretquote');
	    }
	  }
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-8fdafc72/SecretQuote.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
